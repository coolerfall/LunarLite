...
public abstract class PickerTextAdapter extends PickerBaseAdapter {
   ...
   *
   * @param context the current context
   * @param itemResource the resource ID for a layout file containing a TextView to use when
   * instantiating items views
   */
  ...
  @Override public void updateSelectedItem(int position) {
