...
public class PickerView extends View {
  ...
  /* picker scroll listener */ PickerScroller.ScrollingListener scrollingListener =
      new PickerScroller.ScrollingListener() {
        ...
        @Override public void onJustify() {
  ...
  private boolean isValidItemIndex(int index) {
    return mAdapter != null && mAdapter.getItemCount() > 0 && (mIsCyclic
        || index >= 0 && index < mAdapter.getItemCount());
  }
